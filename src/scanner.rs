...
/// ScanResult contains one entrypoint generated by scanner
#[derive(Debug)]
pub struct ScanResult {
    ...
    pub name: String,
    /// Total size of the file or folder
    pub size: u64,
}

/// Scan files in fixed depth mode
...
/// Scan files in single file mode
...
/// Scan files in files folder mode
